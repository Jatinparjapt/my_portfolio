...
import { event as gaEvent } from "@/lib/gtag"; // ✅ import GA tracker
...
function Header() {
  ...
  const handleResumePageClick = () => {
    gaEvent({
      action: "click_resume_page",
      category: "Navigation",
      label: "Resume Page",
    });
  };
      ...
      <nav>
        <div className="flex md:place-content-around place-content-between mx-6">
          <ScrollLink
            ...
            offset={-70}
            duration={500}
            onClick={handleLogoClick} // ✅ log logo click
